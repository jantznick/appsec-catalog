              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className={`text-3xl font-semibold mb-1 ${averageScore >= 76 ? 'text-green-600' :
                      averageScore >= 51 ? 'text-yellow-600' :
                        'text-red-600'
                      }`}>
                      {averageScore}/100
                    </div>
                    <div className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${averageScore >= 76 ? 'bg-green-100 text-green-800' :
