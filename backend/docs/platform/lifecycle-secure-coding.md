...
So these are handled by **attestation**: the application owner asserts that their application meets the standard, records what backs that up, and re-attests on a schedule so the claim doesn't silently go stale. Attested compliance is reported **separately from measured compliance** — "how much of our compliance is self-reported?" is the first question an auditor asks, and it should have a straight answer.
...
|---|---|
| [4.6.12, 6.3.2](/docs/program-infosec-policy) | The reference frameworks above |
| 6.3.7 | OWASP Top 10 as the basis for web application controls |
| 6.3.1 a | Secure coding techniques throughout |
| 6.3.1 b | Validation and integrity checking |
| 6.3.1 c, 6.3.5 | Test data |
| 6.3.3, 6.3.9 | Credentials and secrets |
| 6.3.6 | Vendor default and development accounts |
| 6.3.8 | No back doors |
| 6.3.10 | What ships to production |
| 6.3.13 | Cryptography |
